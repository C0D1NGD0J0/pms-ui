...
describe("AccountActivationView Component", () => {
  ...
  it("should render account verification form", () => {
    ...
    expect(screen.getByText("Complete registration by verifying your account")).toBeInTheDocument();
  ...
  it("should show success message when activation is successful", () => {
    ...
    expect(screen.getByText(/Congratulations, account has now been activated/)).toBeInTheDocument();
